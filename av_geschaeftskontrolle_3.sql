...
-- Started on 2015-04-28 10:35:58 CEST
...
SELECT pg_catalog.setval('auftrag_id_seq', 105, true);
...
SELECT pg_catalog.setval('planzahlung_id_seq', 121, true);
...
SELECT pg_catalog.setval('projekt_id_seq', 45, true);
...
-- Completed on 2015-04-28 10:35:58 CEST
